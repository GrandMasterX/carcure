(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'img/gallery/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'img/gallery/btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'img/gallery/btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'img/gallery/btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'img/gallery/blank.gif',			// (string) Path and the name of a blank image (one pixel)
